...
TITLE B站搜“一只靓仔琦” 更多好玩等你发现（版本2022.08.06持续更新）      互助Q群110555071、576797547
color 8e
:Begain
DEL result.txt
...
ECHO.==============         6、不弹授权大概是驱动问题，安装华为（荣耀）手机助手连接  ==========
ECHO.
ECHO.
ECHO.===============================连接成功后会自动开启主菜单=======================================
...
if /i "%choice%"=="y" adb shell pm uninstall --user 0 com.huawei.hiview
if /i "%choice%"=="y" adb shell pm uninstall --user 0 com.huawei.hiviewtunnel
if /i "%choice%"=="y" adb shell pm uninstall --user 0 com.huawei.android.UEInfoCheck
rem the top 4 are yonghutiyanjihua
...
adb shell pm install-existing --user 0 com.huawei.hiview
adb shell pm install-existing --user 0 com.huawei.hiviewtunnel
adb shell pm install-existing --user 0 com.huawei.android.UEInfoCheck
